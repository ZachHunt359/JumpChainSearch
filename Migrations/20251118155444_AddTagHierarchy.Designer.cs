...
namespace JumpChainSearch.Migrations
{
    ...
    [Migration("20251118155444_AddTagHierarchy")]
    partial class AddTagHierarchy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JumpChainSearch.Models.TagVote", b =>
                {
                    ...
                    b.Property<int?>("TagRemovalRequestId1")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("TagSuggestionId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("TagSuggestionId1")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TagRemovalRequestId1");

                    b.HasIndex("TagSuggestionId");

                    b.HasIndex("TagSuggestionId1");
            ...
            modelBuilder.Entity("JumpChainSearch.Models.TagVote", b =>
                {
                    ...
                    b.HasOne("JumpChainSearch.Models.TagRemovalRequest", null)
                        .WithMany("Votes")
                        .HasForeignKey("TagRemovalRequestId1");
                    ...
                    b.HasOne("JumpChainSearch.Models.TagSuggestion", null)
                        .WithMany("Votes")
                        .HasForeignKey("TagSuggestionId1");
